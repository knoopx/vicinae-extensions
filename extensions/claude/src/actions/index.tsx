...
export const SaveAnswerAction = ({ onAction }: { onAction: () => void }) => (
  <Action icon={Icon.Star} title="Save Answer" onAction={onAction} shortcut={{ modifiers: ["ctrl"], key: "s" }} />
);

export const SaveAsSnippetAction = ({ text, name }: { text: string; name: string }) => null;
